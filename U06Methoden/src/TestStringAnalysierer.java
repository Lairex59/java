...
public class TestStringAnalysierer
{
	public static void main(String[] args) {
		...
		System.out.println("ZaehleBuchstaben(\"Hallo M�ller06\") ergibt " +
				MeinStringAnalysierer.zaehleBuchstaben("Hallo M�ller06"));
		System.out.println("ZaehleBuchstaben(null) ergibt " +
				MeinStringAnalysierer.zaehleBuchstaben(null));
		System.out.println("zaehleNichtBuchstaben(\"Hallo M�ller06\") ergibt " +
				MeinStringAnalysierer.zaehleNichtBuchstaben("Hallo M�ller06"));
