...
public class StoppuhrTest
{
	public static void main(String[] args) {
		...
		uhr.setDateiname("D:\\Laraib\\TFO_Max_Valier_Bozen\\3InfB\\Informatik\\zeiten.csv");
		// F�nfmal wir die Stoppuhr gestartet und gestoppt und dabei die Zeit gemessen
		for (int i = 0; i < 5; i++) {
		...
		// Die f�nf gestoppten Zeiten werden in die csv-Datei geschrieben
